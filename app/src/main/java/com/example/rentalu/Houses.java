...
public class Houses {
    ...
    public Houses(String list_num, String property_type, String date_time, String bedroom, String furniture, String remark, String reporter_name, Float rent_price, byte[] image) {
